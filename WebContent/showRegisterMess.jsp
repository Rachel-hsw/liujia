      ...
      <div id="mainContent"  >
          ...
          <blockquote>
            ...
            <table >
              ...
              <tr>
                <td>工作单位: </td><td><jsp:getProperty name="register" property="company" /></td></tr>
              <tr>
                <td>单位地址: </td><td><jsp:getProperty name="register" property="address"/></td></tr>
              <tr>
                <td>联系电话:</td><td><jsp:getProperty name="register" property="phone" /></td></tr>
              <tr>
                <td>EMIL:</td><td><jsp:getProperty name="register" property="email" />*</td></tr>
              <tr>
              ...
              <tr><td>备注:</td><td><TextArea name="memo" Rows="6" Cols="30"><jsp:getProperty 
                  name="register" property="memo"/></TextArea></td></tr>
              <tr><td></td><td></td></tr>
            </table>
            </center>
          </blockquote>
