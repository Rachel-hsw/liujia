  ...
  <body class="twoColHybLtHdr">
    <div id="container">
      ...
      <div id="mainContent"  >
          ...
          <p>显示考生信息。每页最多显示<jsp:getProperty name="examineebypage" property="pageSize"/>
          当前显示第<jsp:getProperty name="examineebypage" property="showPage"/>页，共有
          <jsp:getProperty name="examineebypage" property="pageAllCount"/>页。当前显示的内容是：
          <center>
          <table width="318" border="1">
           <tr><th>姓名</th><th>类别</th><th>性别</th><th>工作单位</th></tr>
