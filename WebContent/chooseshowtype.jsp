  ...
  <body class="twoColHybLtHdr">
    <div id="container">
      ...
      <div id="mainContent"  >
          ...
          <p><p><font size=5 color=blue>请您选择浏览方式！</font></center>         
          <blockquote>
          <center><p><p>
          <form action="helpShowExamineeByPage" name=form method="post" >
          <table >
          <tr><td>分页显示全体考生信息:</td><td><input name="showPage" type="hidden" size=6" value="1" >
          <input type="submit" value="显示" name="submit" ></td></tr>
          </table>
          </form>
          <form action="helpShowExaminee" name=form method="post">
           <table>
           <tr><td>输入考生身份证号：</td><td><Input name="examID" type=text id="examID">
           <input type="submit" value="显示" name="submit" ></td></tr>
           </table>
          </form>
          </center>
